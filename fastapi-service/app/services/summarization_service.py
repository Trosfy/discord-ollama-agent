...
"""
    ...
    def __init__(self, storage: IConversationStorage, llm: LLMInterface):
        """
        Initialize summarization service.

        Args:
            storage: Conversation storage interface for message persistence
    ...
    async def generate_summary(self, messages: List[Dict]) -> str:
        """
        Generate a summary of all messages (for /summarize command).

        Args:
            messages: List of all message dictionaries to summarize
